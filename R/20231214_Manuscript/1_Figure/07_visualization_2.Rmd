...
p1 + p2
tiff(filename = file.path(path, "results/Manuscript/1_Figure/R/1_c_Figure_2.tiff"),
     width = 115, height = 95, units = "mm", res=600)
p1
dev.off()

# setEPS()
# postscript(file.path(path, "results/Manuscript/1_Figure/UMAP_predicted_celltype_fetahu.eps"), height=3.74, width=4.52)
# p1
# dev.off()
```
