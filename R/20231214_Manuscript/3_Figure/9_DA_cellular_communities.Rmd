...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/3_Figure_dendogram_PT_DE_samples.eps"), height=12, width=30)
plot(hc)
dev.off()

setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/3_Figure_barplot_PT_DE_samples.eps"), height=12, width=20)
p
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/3_Figure_barplot_PT_DE_ME_samples.eps"), height=12, width=20)
p_ME
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/PT_DE_annotation_bar.eps"), height=30, width=30)
...
#absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PT_DE_annotationbar_ncells.eps")), height=30, width=30)
draw(anno_barplot(as.vector(unname(table(sce$sample_id))), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PT_DE_annotationbar_nMEcells.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PT_DE_annotationbar_immune_inf.eps")), height=30, width=30)
draw(anno_barplot(as.vector(immune_infiltration), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PT_DE_annotationbar_immune_inf_norm.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PT_DE_metadata_discrete.eps")), height=40, width=6)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PT_DE_metadata_continuous.eps")), height=40, width=6)
do.call("grid.arrange", c(plot_list, ncol=1))
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/3_Figure_barplot_PT_DE_all_samples.eps"), height=12, width=20)
p_all
dev.off()
```
