...
keep_cols <- spe$celltype != "other" & spe$tissue=="BM" & spe$sample_id%in%samples_with_tumor_cells & spe$control=="no" & spe$timepoint == "DE"
...
#DE
sce_DE <- sce[,sce$metacluster=="tumor"]
p_DE <- plotAbundances(sce_DE, k = "celltype", by = "sample", col_clust=T, k_pal=metadata(spe)$color_vectors$col_celltype_ordered, 
                    linkage="ward.D", distance="manhattan") 
clustered_samples_DE <- levels(p_DE$data$sample_id)
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_timepointamples_DE.eps"), height=12, width=20)
p_DE
dev.off()
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/dendogram_BM_DE_samples.eps"), height=12, width=30)
plot(hc)
dev.off()
```
## Plot overview of cohort - RE1
...
keep_rows <- rowData(spe)$use_channel 
keep_cols <- spe$celltype != "other" & spe$tissue=="BM" & spe$sample_id%in%samples_with_tumor_cells & spe$control=="no" & spe$timepoint == "RE1"
...
```{r diff-freqs-plot-props-barplot, fig.cap = "Relative abundance of the 8 PBMC populations in each sample (x-axis), in the PBMC dataset, represented with a barplot. The 8 cell populations are a result of manual merging of the 20 FlowSOM metaclusters", fig.width=20, fig.height=10}
#DE
sce_RE1 <- sce[,sce$metacluster=="tumor"]
p_RE1 <- plotAbundances(sce_RE1, k = "celltype", by = "sample", col_clust=T, k_pal=metadata(spe)$color_vectors$col_celltype_ordered, 
                    linkage="ward.D", distance="manhattan") 
clustered_samples_RE1 <- levels(p_RE1$data$sample_id)
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_timepointamples_RE1.eps"), height=12, width=20)
p_RE1
dev.off()
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/dendogram_BM_RE1_samples.eps"), height=12, width=30)
plot(hc)
dev.off()
```

## Plot overview of cohort - RE2
...
keep_rows <- rowData(spe)$use_channel 
keep_cols <- spe$celltype != "other" & spe$tissue=="BM" & spe$sample_id%in%samples_with_tumor_cells & spe$control=="no" & spe$timepoint == "RE2"
...
```{r diff-freqs-plot-props-barplot, fig.cap = "Relative abundance of the 8 PBMC populations in each sample (x-axis), in the PBMC dataset, represented with a barplot. The 8 cell populations are a result of manual merging of the 20 FlowSOM metaclusters", fig.width=20, fig.height=10}
#DE
sce_RE2 <- sce[,sce$metacluster=="tumor"]
p_RE2 <- plotAbundances(sce_RE2, k = "celltype", by = "sample", col_clust=T, k_pal=metadata(spe)$color_vectors$col_celltype_ordered, 
                    linkage="ward.D", distance="manhattan") 
clustered_samples_RE2 <- levels(p_RE2$data$sample_id)
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_timepointamples_RE2.eps"), height=12, width=20)
p_RE2
dev.off()
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/dendogram_BM_RE2_samples.eps"), height=12, width=30)
plot(hc)
dev.off()
```

## Plot overview of cohort - REL
...
keep_rows <- rowData(spe)$use_channel 
keep_cols <- spe$celltype != "other" & spe$tissue=="BM" & spe$sample_id%in%samples_with_tumor_cells & spe$control=="no" & spe$timepoint == "REL"
...
```{r diff-freqs-plot-props-barplot, fig.cap = "Relative abundance of the 8 PBMC populations in each sample (x-axis), in the PBMC dataset, represented with a barplot. The 8 cell populations are a result of manual merging of the 20 FlowSOM metaclusters", fig.width=20, fig.height=10}
#DE
sce_REL <- sce[,sce$metacluster=="tumor"]
p_REL <- plotAbundances(sce_REL, k = "celltype", by = "sample", col_clust=T, k_pal=metadata(spe)$color_vectors$col_celltype_ordered, 
                    linkage="ward.D", distance="manhattan") 
clustered_samples_REL <- levels(p_REL$data$sample_id)
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_timepointamples_REL.eps"), height=12, width=20)
p_REL
dev.off()
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/dendogram_BM_REL_samples.eps"), height=12, width=30)
plot(hc)
dev.off()
```
## All samples
...
sce_tumor <- sce[,sce$metacuster=="tumor"]
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_DE_samples_ME_sepclust_RE1RE2.eps"), height=12, width=20)
p_me
dev.off()
```
...
clustered_samples_short <- sapply(strsplit(clustered_samples, "_"), function(x) paste(x[4], x[5], sep = "_"))
rownames(meta_all) <- paste0(meta_all$Sample, "_", meta_all$Tissue)
meta_all <- meta_all[clustered_samples_short,]

setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/annoationbar_BM_timepoint_sepclust_RE1RE2.eps"), height=30, width=30)
...
#absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_ncells_sepclust_RE1RE2.eps")), height=30, width=30)
draw(anno_barplot(as.vector(unname(table(sce$sample_id))), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_ntumorcells_sepclust_RE1RE2.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_tumor_inf_sepclust_RE1RE2.eps")), height=30, width=30)
draw(anno_barplot(as.vector(tumor_infiltration), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_tumor_inf_norm_sepclust_RE1RE2.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_discrete_RE1RE2.eps")), height=30, width=5)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_continuous_RE1RE2.eps")), height=30, width=5)
do.call("grid.arrange", c(plot_list, ncol=1))
dev.off()
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_timepoint_metaclusters_samples_sepclust_RE1RE2.eps"), height=12, width=20)
p_all
dev.off()
```
```