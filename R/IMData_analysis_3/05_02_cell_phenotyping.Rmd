...
logcounts(spe) <- log(counts(spe) + 1)
intensity_mat <- assay(spe, "logcounts")
...
saveRDS(clusters, file.path(path, "results/hyperparameter_tuning/mean-80_logcounts/pg_clusters.rds"))
...
clPARP = intensity_mat_lq_wo_zeros["clPARP_Yb176_mean-80",]
FN = intensity_mat_lq_wo_zeros["Fibronectin_La139_mean-80",]
...
for(i in 1: length(unique(clusters))){
  ...
  clPARP_c = mat_lq["clPARP_Yb176_mean-80",clusters==c]
  FN_c = mat_lq["Fibronectin_La139_mean-80",clusters==c]
  ...
  png(file=file.path(path, paste0("results/hyperparameter_tuning/mean-80_logcounts/heatmaps/", c , ".tiff")),width=18,height=8,units="in", res=1200)
...
for(i in 1: length(unique(clusters))){
  ...
  clPARP_c = mat_lq["clPARP_Yb176_mean-80",clusters==c & tissue ==t]
  FN_c = mat_lq["Fibronectin_La139_mean-80",clusters==c & tissue ==t]
  ...
  png(file=file.path(path, paste0("results/hyperparameter_tuning/mean-80_logcounts/heatmaps/clusters-tissue-sep/", t, "/", t, "_" , c , ".tiff")),width=18,height=8,units="in", res=1200)
...
clPARP_mean = mean_lq[,"clPARP_Yb176_mean-80"]
