...
Following the path of tumor progression, we start with an analysis of the primary site at diagnosis. Therfore, we perform hierarchical clustering of tumor cell composition profiles in primary tumors.
...
columnAnnotation(MYCN_amp=sample_summary$mna, col=list(MYCN_amp=col_code)) %v%
  columnAnnotation(X1q_loss=sample_summary$X1p_loss, col=list(X1q_loss=col_code)) %v%
