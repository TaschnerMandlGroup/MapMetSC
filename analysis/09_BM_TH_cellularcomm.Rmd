...
Therefore, we define function for converting the SPE objects into catalayst compatible objects, for hierarhichal clustering and plotting of barplots and dendograms. 
```{r functions}
