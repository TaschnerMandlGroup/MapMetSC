...
```{r filter}
col_filter <- c("R", "PBMC_R", "CLB", "CLB_D")
...
```{r heatmap-inf-filtered, fig.width=7, fig.height=4}
...
Heatmap(scale(t(df[row_filter_inf, col_filter])), 
        ...
        row_order = c("R", "PBMC_R", "CLB", "CLB_D"),
        col=viridis(100)
        )
```
```{r heatmap-inf, fig.width=11, fig.height=4}
...
```{r heatmap-che-filtered, fig.width=7, fig.height=4}
...
```{r heatmap-che, fig.width=11, fig.height=4}
...
```{r heatmap-rec-filtered, fig.width=3, fig.height=4}
...
```
```{r heatmap-rec, fig.width=11, fig.height=4}
...
```
```{r heatmap-combined-filtered, fig.width=20, fig.height=4}
...
```
```{r heatmap-combined-clustered-filtered, fig.width=20, fig.height=4}
Heatmap(scale(t(df[,col_filter])), 
...
```{r heatmap-combined-all, fig.width=20, fig.height=4}
...
```
```{r heatmap-combined-clustered-all, fig.width=20, fig.height=4}
Heatmap(scale(t(df[,col_filter])), 
