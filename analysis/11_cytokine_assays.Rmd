...
Let's plot a heatmap of the enriched cytokines only.

```{r heatmap-enriched, fig.width=19, fig.height=7}
df <- df_up
...
setEPS()
postscript("/mnt/Multimodal_Imaging_Daria/PIPELINE/NEWEST_RESULTS/results/Manuscript/cytokines/20240728_heatmap_cytokines_nMNA.eps", height=3.5, width=8)
