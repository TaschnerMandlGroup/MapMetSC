...
dittoHeatmap(spe[,cur_cells], genes = rownames(spe)[rowData(spe)$use_channel],
             ...
             heatmap.colors = viridis(100), annot.by = "tissue",
...
p3 <- dittoDimPlot(spe, var = "imc_date", reduction.use = "UMAP", size = 0.2, legend.show = T, opacity=1, order="randomize") +
...
path <- paste("/mnt/Multimodal_Imaging_Daria/_Data_Analysis/_tmp_daria/Image_analysis/20221102_Steinbock_Mesmer_IFbased/data/", tissue, sep="")
