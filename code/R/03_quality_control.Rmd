...
set.seed(220225)
spe <- runUMAP(spe, subset_row = rowData(spe)$use_channel, exprs_values = "compexprs", BPPARAM = MulticoreParam()) 
...
p1 <- dittoDimPlot(spe, var = "sample", reduction.use = "UMAP", size = 0.2, legend.show = FALSE) + 
...
for(i in 1: length(samples)){
  ...
  plot_list[[i]] <- dittoDimPlot(spe, var = "sample_binary", reduction.use = "UMAP", size = 0.04, legend.show = F, opacity=1, order = "increasing") +
...
saveRDS(spe, file.path(path,"data/spe_reduced.rds"))
```
