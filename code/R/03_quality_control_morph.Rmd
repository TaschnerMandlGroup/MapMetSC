...
ggsave(filename=file.path(out_path, "BM_UMAP_single_marker_int-morph_clipped_0-mean.tiff"), width = 7, height = 30, units = "in", device='tiff', dpi=500)
...
save_tiff <- function(sublist, j){
  ...
  ggsave(filename=file.path(out_path, paste("BM_int-morph-clipped_mean-intens_UMAP_single_sample_", j, ".tiff", sep="")), width = 7, height = 20, units = "in", device='tiff', dpi=500)
}
