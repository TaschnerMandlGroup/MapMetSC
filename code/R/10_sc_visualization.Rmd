...
# MDS pseudobulk by cell type
spe_cat <- spe_bm
#spe_cat$sample_id <- spe$sample
spe_cat$sample_id <- factor(spe_cat$sample_id)
#spe_cat$cluster_id <- factor(spe_cat$pg_clusters_fastMNN)
spe_cat$cluster_id <- factor(spe_cat$year)
spe_cat$condition <- factor(spe_cat$tissue)
