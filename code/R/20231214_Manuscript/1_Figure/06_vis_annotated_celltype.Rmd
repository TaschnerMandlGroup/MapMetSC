...
#for(i in 1: 1){
  ...
  plotCells(masks,
            object = spe[, spe$metacluster!="other"],
            cell_id = "ObjectNumber", img_id = "sample_id",
            colour_by = "celltype_2",
            colour = list(celltype_2 = metadata(spe)$color_vectors$col_celltype_2),
            display = "single",
            save_plot = list(filename = file.path(path, "tmp", tissue, paste0("CT2_", files[i], "f"))),
