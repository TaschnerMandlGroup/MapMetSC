...
rna <- readRDS(file.path(path,"results/Manuscript/1_Figure/public_datasets/Lee/disco_bone_marrow_v2.0.rds"))
...
saveRDS(predicted_labels, file.path(path, "results/Manuscript/1_Figure/public_datasets/Lee/predicted_labels.rds"))
...
predicted_colors <- read.csv(file.path(path, "results/Manuscript/1_Figure/public_datasets/Lee/celltype_metacluster.csv"), sep=";")
col_predicted <- setNames(predicted_colors$color, predicted_colors$celltype)
col_predicted <- c(col_predicted, c("tumor" = "palegreen4", "other"="goldenrod1"))
...
saveRDS(spe, file.path(path, "results/Manuscript/1_Figure/public_datasets/Lee/spe_predicted.rds"))
```
...
tiff(filename = file.path(path, "results/Manuscript/1_Figure/public_datasets/Lee/UMAP_predicted_celltype2.tiff"),
