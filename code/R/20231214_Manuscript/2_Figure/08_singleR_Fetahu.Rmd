---
title: "SingleR for label transfer"
...
Here we will read in single-cell RNAseq data from the single-cell bone marrow atlas by 
[Fetahu et al.](https://pubmed.ncbi.nlm.nih.gov/37365178/), and
...
monocle_cell_dataset <- readRDS(file.path(path,"results/Manuscript/2_Figure/public_datasets/Fetahu/rna_integrated_monocle.rds"))
rna <- as.Seurat(monocle_cell_dataset, data=NULL)
rna <- RenameAssays(object = rna, originalexp = 'RNA')
celltype_details <- readRDS(file.path(path,"results//Manuscript/2_Figure/public_datasets/Fetahu/metadata.rds"))
...
protein2gene <- read.csv(file.path(path,"results/Manuscript/2_Figure/public_datasets/protein2gene.csv"), sep=";")
...
#saveRDS(protein, file.path(path, "results/Manuscript/2_Figure/Sara/imc_seurat.rds"))
...
#predicted_labels <- readRDS(file.path(path, "results/Manuscript/2_Figure/public_datasets/Fetahu/20231030_predicted_labels.rds"))
setEPS()
postscript(file.path(path, "results/Manuscript/2_Figure/public_datasets/Fetahu/score_heatmap.eps"), height=6, width=6)
...
tiff(filename = file.path(path, "results/Manuscript/2_Figure/public_datasets/Fetahu/score_heatmap.tiff"),
...
```{r mean-per-cluster-predicted, fig.height= 5, fig.width= 5, message=FALSE}
library(bruceR)
...
#saveRDS(spe, file.path(path, "results/Manuscript/2_Figure/public_datasets/Fetahu/spe_predicted.rds"))
```
...
tiff(filename = file.path(path, "results/Manuscript/2_Figure/public_datasets/Fetahu/UMAP_predicted_celltype.tiff"),
...
tiff(filename = file.path(path, "results/Manuscript/2_Figure/public_datasets/Fetahu/UMAP_predicted_metacluster.tiff"),
     width = 115, height = 95, units = "mm", res=600)
p1
dev.off()
