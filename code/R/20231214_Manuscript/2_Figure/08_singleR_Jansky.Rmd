...
rna <- readRDS(file.path(path,"results/Manuscript/2_Figure/public_datasets/Jansky/adrenal_medulla_Seurat.RDS"))
...
setEPS()
postscript(file.path(path, "results/Manuscript/2_Figure/public_datasets/Jansky/Jansky_bubbleplot_scaled.eps"), height=6, width=8)
d1
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/2_Figure/public_datasets/Jansky/Jansky_PCA_biplot.eps"), height=6, width=8)
pca
dev.off()
