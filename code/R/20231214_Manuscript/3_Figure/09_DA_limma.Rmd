...
setEPS()
postscript(file.path(path, "results/Manuscript/2_Figure/R/PT_nMNAvsMNA_tumor_celltype_edgeR.eps"), height=26, width=20)
...
setEPS()
postscript(file.path(path, "results/Manuscript/2_Figure/R/PT_MNAvsnMNA_ME_celltype_dodge.eps"), height=4, width=12)
