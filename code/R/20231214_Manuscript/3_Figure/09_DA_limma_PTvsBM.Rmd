...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/barplot_PTvsBM_samples.eps"), height=12, width=20)
p
dev.off()
```
...
test <- compare_means(het ~ condition, 
                        ...
                        data = heterogeneity)
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/PTvsBM_het.eps"), height=5, width=5)
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/annotationbar_PTvsBM.eps"), height=30, width=30)
...
sce$sample_id <- factor(sce$sample_id, levels=clustered_samples)
 ...
 #absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/PTvsBM_annotationbar_ncells.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/PTvsBM_tumor_boxplot.eps"), height=26, width=20)
...
#Piechart
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/PTvsBM_piechart.eps"), height=2, width=6.5)
