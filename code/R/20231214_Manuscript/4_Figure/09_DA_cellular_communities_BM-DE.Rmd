...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/dendogram_BM_DE_samples.eps"), height=12, width=30)
plot(hc)
dev.off()

setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/barplot_BM_DE_samples_celltype.eps"), height=12, width=20)
p
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/barplot_BM_DE_samples_ME.eps"), height=12, width=20)
p_me
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/BM_DE_annotation_bar.eps"), height=30, width=30)
...
#absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_annotationbar_ncells.eps")), height=30, width=30)
draw(anno_barplot(as.vector(unname(table(sce$sample_id))), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_annotationbar_ntumorcells.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_annotationbar_tumor_inf.eps")), height=30, width=30)
draw(anno_barplot(as.vector(tumor_infiltration), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_annotationbar_tumor_inf_norm.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_discrete.eps")), height=30, width=5)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_continuous.eps")), height=30, width=5)
do.call("grid.arrange", c(plot_list, ncol=1))
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/BM_DE_cellular-communities_ME_boxplot_edgeR.eps"), height=26, width=20)
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/BM_DE_cellular-communities_ME_barplots_voom.eps"), height=12, width=16)
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/BM_DE_barplot_all_metaclusters.eps"), height=12, width=16)
