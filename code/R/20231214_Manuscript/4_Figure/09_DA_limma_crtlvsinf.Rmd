...
keep_cols <- spe$celltype != "other" & (spe$timepoint=="DE"|spe$timepoint=="") & spe$metacluster=="tumor" 
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/barplot_BM_crtlvsDE_samples.eps"), height=12, width=20)
p
dev.off()
```
...
#absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/Manuscript/3_Figure/R/BM_crtlvsDE_annotationbar_ncells.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/PTvsBM_tumor_boxplot_voom.eps"), height=26, width=20)
...
setEPS()
postscript(file.path(path, "results/Manuscript/3_Figure/R/PT_crtl_BM_bar_metacluster.eps"), height=4, width=8)
