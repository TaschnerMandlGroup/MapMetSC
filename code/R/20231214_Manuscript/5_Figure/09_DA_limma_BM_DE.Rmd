...
keep_cols <- spe$celltype != "other" & spe$timepoint=="DE" & spe$metacluster=="tumor" & & spe$tissue=="BM" & (spe$MYCN_amp==1 | spe$MYCN_amp==0)
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/barplot_BM_DE_NoProgvsProg_samples.eps"), height=12, width=20)
p
dev.off()
```
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/4_Figure/R/BM_DE_NoProgvsProg_continuous.eps")), height=30, width=5)
...
setEPS()
postscript(file.path(path, "results/Manuscript/4_Figure/R/BM_DE_nMNAvsMNA_tumor_boxplot_voom.eps"), height=26, width=20)
