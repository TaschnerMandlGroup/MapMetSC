...
keep_rows <- rowData(spe)$use_channel 
keep_cols <- spe$celltype != "other" & spe$tissue=="BM" & spe$sample_id%in%samples_with_tumor_cells & spe$control=="no" & (spe$timepoint == "RE1" | spe$timepoint == "RE2")
...
clustered_samples <- c(clustered_samples_DE, clustered_samples_RE2, clustered_samples_REL)
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_DE_samples_ME_sepclust.eps"), height=12, width=20)
p_me
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/annoationbar_BM_timepoint_sepclust.eps"), height=30, width=30)
...
#absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_ncells_sepclust.eps")), height=30, width=30)
draw(anno_barplot(as.vector(unname(table(sce$sample_id))), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_ntumorcells_sepclust.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_tumor_inf_sepclust.eps")), height=30, width=30)
draw(anno_barplot(as.vector(tumor_infiltration), add_numbers=T, height = unit(1, "cm")))
dev.off() 

setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_annotationbar_tumor_inf_norm_sepclust.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_discrete.eps")), height=30, width=5)
...
setEPS()
postscript(file.path(path, paste0("results/Manuscript/6_Figure/R/BM_timepoint_continuous.eps")), height=30, width=5)
do.call("grid.arrange", c(plot_list, ncol=1))
dev.off()
...
setEPS()
postscript(file.path(path, "results/Manuscript/6_Figure/R/barplot_BM_timepoint_metaclusters_samples_sepclust.eps"), height=12, width=20)
p_all
dev.off()
```
```