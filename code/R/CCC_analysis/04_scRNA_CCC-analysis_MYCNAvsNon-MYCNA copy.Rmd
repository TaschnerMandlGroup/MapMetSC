...
# ___UMAP with all metaclusters___
...
figureS7_B_partI <- SCpubr::do_DimPlot(rna,
                                 border.color = "black",
...
figureS7_B_CD274 <-  SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[1],
                                         pt.size = 0.5,
                                         order = TRUE,
                                         label = FALSE,
                                         font.size = 14,
                                         ...
                                         viridis_color_map = "A",
                                         legend.length = 10,
                                         plot.title = "\t CD274 Gene expression",
                                         max.cutoff = 3
                                         )

figureS7_B_PDCD1 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[2],
                                         pt.size = 0.5,
                                         order = TRUE,
                                         label = FALSE,
                                         font.size = 14,
                                         ...
                                         viridis_color_map = "A",
                                         legend.length = 10,
                                         plot.title = "\t PDCD1 Gene expression",
                                         max.cutoff = 4
                                         )

figureS7_B_CD8A <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[3],
                                         pt.size = 0.5,
                                         order = TRUE,
                                         label = FALSE,
                                         font.size = 14,
                                         ...
                                         viridis_color_map = "A",
                                         legend.length = 10,
                                         plot.title = "\t CD8A Gene expression",
                                         max.cutoff = 20
                                         )

figureS7_B_CD4 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[4],
                                         pt.size = 0.5,
                                         order = TRUE,
                                         label = FALSE,
                                         font.size = 14,
                                         ...
                                         viridis_color_map = "A",
                                         legend.length = 10,
                                         plot.title = "\t CD4 Gene expression",
                                         max.cutoff = 10
                                         )

figureS7_B_GZMB <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[5],
                                         pt.size = 0.5,
                                         order = TRUE,
                                         label = FALSE,
                                         font.size = 14,
                                         ...
                                         viridis_color_map = "A",
                                         legend.length = 10,
                                         plot.title = "\t GZMB Gene expression",
                                         max.cutoff = 50
                                         )

figureS7_B_S100B <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[6],
                                         pt.size = 0.5,
                                         order = TRUE,
                                         label = FALSE,
                                         font.size = 14,
                                         ...
                                         viridis_color_map = "A",
                                         legend.length = 10,
                                         plot.title = "\t S100B Gene expression",
                                         max.cutoff = 15
                                         )
...
# save plots PART II
pdf(paste0(params$out,"figures/FigureS7-B_CD274.pdf"),
    height = 5 ,width = 4)
figureS7_B_CD274
dev.off()

png(paste0(params$out,"figures/FigureS7-B_CD274.png"),
    height = 1000,width = 800)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[1],
                                         pt.size = 2,
                                         order = TRUE,
...
pdf(paste0(params$out,"figures/FigureS7-B_PDCD1.pdf"),
    height = 5 ,width = 4)
figureS7_B_CD274
dev.off()

png(paste0(params$out,"figures/FigureS7-B_PDCD1.png"),
    height = 1000,width = 800)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[2],
...
pdf(paste0(params$out,"figures/FigureS7-B_CD8A.pdf"),
    height = 5 ,width = 4)
figureS7_B_CD8A
dev.off()

png(paste0(params$out,"figures/FigureS7-B_CD8A.png"),
    height = 1000,width = 800)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[3],
...
pdf(paste0(params$out,"figures/FigureS7-B_CD4.pdf"),
    height = 5 ,width = 4)
figureS7_B_CD4
dev.off()

png(paste0(params$out,"figures/FigureS7-B_CD4.png"),
    height = 1000,width = 800)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[4],
...
pdf(paste0(params$out,"figures/FigureS7-B_GZMB.pdf"),
    height = 5 ,width = 4)
figureS7_B_GZMB
dev.off()

png(paste0(params$out,"figures/FigureS7-B_GZMB.png"),
    height = 1000,width = 800)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[5],
...
pdf(paste0(params$out,"figures/FigureS7-B_S100B.pdf"),
    height = 5 ,width = 4)
figureS7_B_S100B
dev.off()

png(paste0(params$out,"figures/FigureS7-B_S100B.png"),
    height = 1000,width = 800)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = genes.to.plot[6],
...
pdf(paste0(params$out,"figures/Figure5-I_DotPlot_v1_final.pdf"),
    width = 7.05,height = 4.31)
dotplot_final
dev.off()

dotplot_final_v2 <- SCpubr::do_DotPlot(sample = tcells_tumorcells, 
                                    plot.title = "\t T-cell markers",
                                    features = genes,
                                    font.size = 16,
                                    flip = FALSE,
...
pdf(paste0(params$out,"figures/Figure5-I_DotPlot_v2_final.pdf"),
    width = 7.05,height = 4.31)
dotplot_final_v2
dev.off()
...
png(paste0(params$out,"figures/Figure5-I_DotPlot_final.png"),
    width = 657,height = 422)
SCpubr::do_DotPlot(sample = tcells_tumorcells, 
                                    plot.title = "\t T-cell markers",
                                    features = genes,
                                    font.size = 22,
                                    flip = FALSE,
...
```{r}
clusters_of_interest <- c("T (5)", "T (6)", "T (9)")
tcells <- subset(rna, idents = clusters_of_interest, invert = FALSE)
```
...
tcells@meta.data <- metadata[, !colnames(metadata) %in% cols_to_remove]

head(tcells@meta.data)
```

```{r}
exhustion_genes <- genes$`Exhaustion
markers`

length(exhustion_genes)
...
# extract counts
counts <- tcells@assays$RNA@data
var_genes <- dimnames(counts)[[1]]

# remove genes not present in dataset
exhustion_genes <- intersect(exhustion_genes, var_genes)
print("Number of overlapping genes: ")
length(exhustion_genes)

# calculate module score
tcells <- AddModuleScore(object = tcells,
                         ctrl = 5,
                         features = exhustion_genes,
                         name = "exhaustion_profile",
                         seed = 2805)
```

```{r}
do_DotPlot(sample = tcells, 
           features = "exhaustion_profile1",
           plot.title = "T-cell: exhaustion profile",
           plot.subtitle = "Exhaustion module scores",
           legend.length = 5,
           font.size = 22,
           dot.scale = 30,
           dot_border = FALSE,
...
do_FeaturePlot(sample = tcells, 
               ...
               slot = "data",
               plot.axes = TRUE,
               legend.title = "Exhaustion module scores",
               legend.length = 10)
...
FeaturePlot(tcells, 
            ...
            order = TRUE,
            features = "exhaustion_profile1",
            cols = c("lightpink","purple","purple4")) +
  scale_colour_gradientn(colours = rev(brewer.pal(n = 10, 
                                                 name = "PuOr"))) +
...
```{r}
Idents(tcells_tumorcells) <- tcells_tumorcells$group

MNA_patients <- "II"
nMNA_patients <- c("III","IV")

nMNA_tcells_tumorcells <- subset(tcells_tumorcells, 
                                 idents = nMNA_patients, 
                                 invert = FALSE)

MNA_tcells_tumorcells <- subset(tcells_tumorcells, 
                                idents = MNA_patients, 
                                invert = FALSE)
```

```{r}
Idents(nMNA_tcells_tumorcells) <- nMNA_tcells_tumorcells$original_celltype

SCpubr::do_DotPlot(sample = nMNA_tcells_tumorcells, 
                   plot.title = "\t T-cell markers",
                   plot.subtitle = "\t \t nMNA patients",
                   features = genes,
                   font.size = 16,
                   flip = FALSE,
                   dot.scale = 8,
...
Idents(MNA_tcells_tumorcells) <- MNA_tcells_tumorcells$original_celltype

SCpubr::do_DotPlot(sample = MNA_tcells_tumorcells, 
                   plot.title = "\t T-cell markers",
                   plot.subtitle = "\t \t MNA patients",
                   features = genes,
                   font.size = 16,
                   flip = FALSE,
                   dot.scale = 8,
...
combined_umap <- DimPlot(rna, 
                         cols = COLOR_CODE_RNA_v3, 
                         seed = 28, 
                         shuffle = TRUE) + 
...
# save plots
pdf(paste0(params$out,"figures/fetahu2023_UMAPs_MNA_nMNA.pdf"),
    height = 7, width = 21)
mycn_umap + non_mycn_umap  
dev.off()

png(filename = paste0(params$out,"figures/fetahu2023_UMAPs_MNA_nMNA.png"),
    width = 2100, height = 700, units = "px", pointsize = 1, res = 150)
mycn_umap + non_mycn_umap  
dev.off()

tiff(filename = paste0(params$out,"figures/fetahu2023_UMAPs_MNA_nMNA.tiff"),
...
ccc.publication <- function(seurat) {
  ...
  pdf(paste0(params$out,"figures/Figure7-B_final_",count,".pdf"))
  circo_plot
  dev.off()
...
```{r CTRL vs NB}
Idents(rna_subset) <- rna_subset@meta.data$group

NB_patients <- c("II","III","IV")
control_patients <- "I"

rna_subset@meta.data$case_control <- NA
rna_subset@meta.data <- rna_subset@meta.data %>% 
  mutate(case_control = ifelse((rna_subset@meta.data$group == "I"),  
                             "CTRL","NB"))

table(rna_subset@meta.data$case_control)

Idents(rna_subset) <- factor(rna_subset@meta.data$case_control)
CTRL <- subset(rna_subset, idents = "CTRL")
NB <- subset(rna_subset, idents = "NB")

count = 0

sample.list <- list(CTRL, NB)
setNames(sample.list, c("CTRL", "NB"))
...
if(save == TRUE){
  saveRDS(multinichenet_output, paste0(params$out,"Rds/multiNicheNet_nMNA-vs-MNA.Rds")
}
```
...
visualize_network <- function (network, colors) {
  ...
  nodes = network$nodes %>% data.frame() %>% 
    magrittr::set_rownames(network$nodes$node)
  ...
  network_igraph = igraph::graph_from_data_frame(d = network$links %>% 
    dplyr::filter(type == "Ligand-Target"), vertices = nodes, directed = T)
  ...
  plot = ggraph::ggraph(network_tidygraph, layout = "dh") + 
    ggraph::geom_edge_fan(aes(color = direction_regulation), 
      edge_width = 1, arrow = arrow(length = unit(1, "mm")), 
      end_cap = ggraph::circle(5.5, "mm"), 
      start_cap = ggraph::circle(3,  "mm")) + 
    ggraph::geom_node_label(aes(label = gene, fill = celltype), 
                            fontface = "bold", 
                            size = 2.5, 
                            nudge_x = 0, 
                            nudge_y = 0, 
                            color = "white", 
                            repel = FALSE) + 
    ggraph::theme_graph(foreground = "black", 
...
multinichenet_output <- readRDS(paste0(params$out,"Rds/multiNicheNet_nMNA-vs-MNA.Rds"))
...
# save results
output_nMNAvsMNA <- as.data.frame(prioritized_tbl_oi)
write.table(output_nMNAvsMNA, 
            file = paste0(params$out,"tables/multiNicheNet_LR_TOP100_nMNA-vs-MNA.csv"),
...
pdf(paste0(params$out,"figures/MultiNicheNet_circos_plot_nMNAvsMNA_top50.pdf"),
    height = 8, width = 8)
circos_list
dev.off()
...
filter_group <- prioritized_tbl_oi_filtered$group == "nonMYCNA"
prioritized_nMNA_filtered <- prioritized_tbl_oi_filtered[filter_group,]

prioritized_nMNA_filtered <- prioritized_nMNA_filtered %>%
  filter(sender != receiver) # removing CCC within the same group

prioritized_nMNA_filtered <- head(prioritized_nMNA_filtered, n = 50)

plot_oi_nMNA = make_sample_lr_prod_activity_plots(
  multinichenet_output$prioritization_tables, 
  prioritized_nMNA_filtered)

plot_oi_nMNA # Samples that were left out of the DE analysis are indicated with 
# a smaller dot (this helps to indicate the samples that did not contribute to 
# the calculation of the logFC, and thus not contributed to the final prioritization)

# save plots
pdf(paste0(params$out,"figures/multiNicheNet_nMNA_top50.pdf"),
    height = 12, width = 14,pointsize = 1)
plot_oi_nMNA
dev.off()

png(paste0(params$out,"figures/multiNicheNet_nMNA_top50.png"),
   height = 1700, width = 2000, units = "px", pointsize = 1, res = 150)
plot_oi_nMNA 
dev.off()

tiff(paste0(params$out,"figures/multiNicheNet_nMNA_top50.tiff"),
...
filter_group <- prioritized_tbl_oi_filtered$group == "MYCNA"
prioritized_MNA_filtered <- prioritized_tbl_oi_filtered[filter_group,]

prioritized_MNA_filtered <- prioritized_MNA_filtered %>%
  filter(sender != receiver) # removing CCC within the same group

prioritized_MNA_filtered <- head(prioritized_MNA_filtered, n = 50)

plot_oi_MNA = make_sample_lr_prod_activity_plots(
  multinichenet_output$prioritization_tables, 
  prioritized_MNA_filtered)

plot_oi_MNA

# save plots
pdf(paste0(params$out,"figures/multiNicheNet_MNA_top50.pdf"),
    height = 12,width = 14,pointsize = 1)
plot_oi_MNA
dev.off()

png(paste0(params$out,"figures/multiNicheNet_MNA_top50.png"),
   height = 1700, width = 2000, units = "px", pointsize = 1, res = 150)
plot_oi_MNA 
dev.off()

tiff(paste0(params$out,"figures/multiNicheNet_MNA_top50.tiff"),
    height = 1700, width = 2000, units = "px", res = 150, pointsize = 1)
plot_oi_MNA 
dev.off() 
...
contrast_tbl = tibble(contrast =  c("nonMYCNA-MYCNA","MYCNA-nonMYCNA"), 
                      group = c("nonMYCNA","MYCNA"))
...
pdf(paste0(params$out,"figures/Figure_7-D_multiNicheNet_networkGraph_final.pdf"),
    height = 8, width = 20)
final_network
dev.off()

tiff(paste0(params$out,"figures/Figure_7-D_multiNicheNet_networkGraph_final.tiff"),
     width = 265.9449, height = 265.9449,units = "in", res = 100)
final_network
dev.off()

igraph_network <- graph_from_data_frame(network$nodes, directed = TRUE, vertices = NULL)
plot.igraph(igraph_network)
...
output_nMNAvsMNA <- as.data.frame(prioritized_tbl_oi)
write.table(output_nMNAvsMNA, 
            file = paste0(params$out,"tables/multiNicheNet_output_nMNA-vs-MNA.csv"),
            sep = "\t", quote = FALSE, row.names = FALSE)

```

# __Figure S7, B: Monocyte markers___

```{r fig.height=5, fig.width=6}
# Classical monocytes: CD14++ CD16- CCR2+ CCR5+ CD62L+
# Intermediate monocytes: CD14++ CD16+ HLA-DR+ CD68+ CD11c+
# Non-classical monocytes: CD14+ CD16++ HLA-DR+ CXCR1+
# "HLA-DRA","HLA-DRB1","HLA-DRB3","HLA-DRB4","HLA-DRB5"

Idents(rna) <- rna@meta.data$original_celltype

# define which clusters to compare
clusters_of_interest <- c("M (1)", "M (2)", "M (10)", 
                          "NB (8)") 
# Clusters T (18) and M (15) were excluded due to low cell numbers (<100)

rna_monocyte <- subset(rna, idents = clusters_of_interest, invert = FALSE)
# CD16 = FCGR3A 
# CD62L = SELL
# CD11C = ITGAX
monocyte_markers <- c("CD14","FCGR3A",
                      "CCR2","CCR5","SELL",
                      "CD68","ITGAX",
                      "CXCR1",                  "HLA-DRA","HLA-DRB1","HLA-DRB3","HLA-DRB4","HLA-DRB5")

figureS7B_dotplot <- SCpubr::do_DotPlot(sample = rna_monocyte,
                                    plot.title = "\t \t Monocyte markers",
...
png(paste0(params$out,"/figures/fetahu2023_dotplot_monocytes.png"),
           height = 300, width = 724)
SCpubr::do_DotPlot(sample = rna_monocyte, 
                                    plot.title = "\t \t Monocyte markers",
                                    features = monocyte_markers,
                                    font.size = 20,
                                    flip = FALSE,
...
pdf(paste0(params$out,"/figures/fetahu2023_dotplot_monocytes.pdf"),
           height = 3.47, width = 7.54)
figureS7B_dotplot
dev.off()

# M (10) = Non-classical monocytes
# M (1) = Classical monocytes
# M (2) = Intermediate monocytes
# M (15) = Intermediate monocytes
```

```{r fig.height=5, fig.width=4}
figureS7B_featureplot_1 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CD14",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CD14 gene expression",
                                         max.cutoff = 40)

png(paste0(params$out,"/figures/fetahu2023_featureplot_CD14.png"),
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CD14.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_1
dev.off()

figureS7B_featureplot_2 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "FCGR3A",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CD16 gene expression",
                                         max.cutoff = 40)
figureS7B_featureplot_2

png(paste0(params$out,"/figures/fetahu2023_featureplot_CD16.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "FCGR3A",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CD16.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_2
dev.off()

figureS7B_featureplot_3 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "SELL",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CD62L gene expression",
                                         max.cutoff = 30)
figureS7B_featureplot_3

png(paste0(params$out,"/figures/fetahu2023_featureplot_CD62L.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "SELL",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CD62L.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_3
dev.off()

figureS7B_featureplot_4 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "ITGAX",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CD11C gene expression",
                                         max.cutoff = 40)
figureS7B_featureplot_4

png(paste0(params$out,"/figures/fetahu2023_featureplot_CD11C.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "ITGAX",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CD11C.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_4
dev.off()

figureS7B_featureplot_5 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CCR2",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CCR2 gene expression",
                                         max.cutoff = 7)
figureS7B_featureplot_5

png(paste0(params$out,"/figures/fetahu2023_featureplot_CCR2.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CCR2",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CCR2.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_5
dev.off()

figureS7B_featureplot_6 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CCR5",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CCR5 gene expression",
                                         max.cutoff = 3)
figureS7B_featureplot_6

png(paste0(params$out,"/figures/fetahu2023_featureplot_CCR5.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CCR5",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CCR5.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_6
dev.off()

figureS7B_featureplot_7 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CD68",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CD68 gene expression",
                                         max.cutoff = 30)
figureS7B_featureplot_7

png(paste0(params$out,"/figures/fetahu2023_featureplot_CD68.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CD68",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CD68.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_7
dev.off()

figureS7B_featureplot_8 <- SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CXCR1",
                                         order = TRUE,
                                         label = FALSE,
                                         ...
                                         legend.length = 10,
                                         plot.title = "\t Monocyte markers",
                                         plot.subtitle = "\t   CXCR1 gene expression",
                                         max.cutoff = 40)
figureS7B_featureplot_8

png(paste0(params$out,"/figures/fetahu2023_featureplot_CXCR1.png"),
           height = 500, width = 400)
SCpubr::do_FeaturePlot(sample = rna,
                                         reduction = "UMAP",
                                         features = "CXCR1",
...
pdf(paste0(params$out,"/figures/fetahu2023_featureplot_CXCR1.pdf"),
           height = 5, width = 4)
figureS7B_featureplot_8
dev.off()
```
...
# ___Figure 5, I and Figure S7, D: CCC analysis, NB vs. CTRL___
...
if(save == TRUE){
  saveRDS(multinichenet_output, paste0(params$out,"Rds/multiNicheNet_NB-vs-CTRL.Rds"))
}
```

```{r MultiNicheNet figures III}
multinichenet_output <- readRDS(paste0(params$out,"Rds/multiNicheNet_NB-vs-CTRL.Rds"))

colors_sender <- NULL
colors_receiver <- NULL

# set color code RNA_COLOR_CODE_v3
colors_sender["NB..8."] = "palegreen4"
colors_sender["T..5."] = "#cc0000"
colors_sender["T..6."] = "darkred"
colors_sender["T..9."] = "#f44336"
...
pdf(paste0(params$out,"figures/Figure_S5-A_multiNicheNet_CTRLvsNB_circos_plot_final.pdf"),
    height = 8, width = 8,pointsize = 1)
circos_list
dev.off()

png(paste0(params$out,"figures/Figure_S5-A_multiNicheNet_CTRL_circos_plot_final.png"),
    height = 1500, width = 1500, units = "px", pointsize = 2, res = 200)
circos_list$CTRL 
dev.off()

png(paste0(params$out,"figures/Figure_S5-A_multiNicheNet_NB_circos_plot_final.png"),
    height = 1500, width = 1500, units = "px", pointsize = 2, res = 200)
circos_list$NB 
dev.off()
...
prioritized_tbl_oi_M_50 = get_top_n_lr_pairs(
  multinichenet_output$prioritization_tables, 
  top_n = 100, rank_per_group = FALSE,
  groups_oi = group_oi)

#prioritized_tbl_oi_M_50 <- prioritized_tbl_oi_M_50 %>%
#  filter(sender != receiver) # removing CCC within the same group

filter_group <- prioritized_tbl_oi$group == group_oi
prioritized_NB_filtered <- prioritized_tbl_oi[filter_group,]

#prioritized_NB_filtered <- prioritized_NB_filtered %>%
#  filter(sender != receiver) # removing CCC within the same group

prioritized_NB_filtered <- head(prioritized_NB_filtered, n = 50)

plot_oi_NB = make_sample_lr_prod_activity_plots(
  multinichenet_output$prioritization_tables, 
  prioritized_NB_filtered)
...
# save plots
pdf(paste0(params$out,"figures/Figure_S5-D_multiNicheNet_NB_top50.pdf"),
    height = 12, width = 14,pointsize = 1)
plot_oi_NB
dev.off()

png(paste0(params$out,"figures/Figure_S5-D_multiNicheNet_NB_top50.png"),
   height = 1700, width = 2000, units = "px", pointsize = 1, res = 150)
plot_oi_NB 
dev.off()

tiff(paste0(params$out,"figures/Figure_S5-D_multiNicheNet_NB_top50.tiff"),
    height = 1700, width = 2000, units = "px", res = 150, pointsize = 1)
plot_oi_NB 
dev.off() 
...
filter_group <- prioritized_tbl_oi$group == group_oi
prioritized_CTRL_filtered <- prioritized_tbl_oi[filter_group,]

#prioritized_CTRL_filtered <- prioritized_CTRL_filtered %>%
#  filter(sender != receiver) # removing CCC within the same group

prioritized_CTRL_filtered <- head(prioritized_CTRL_filtered, n = 50)

plot_oi_CTRL = make_sample_lr_prod_activity_plots(
  multinichenet_output$prioritization_tables, 
  prioritized_CTRL_filtered)

plot_oi_CTRL

# save plots
pdf(paste0(params$out,"figures/Figure_S5-D_multiNicheNet_CTRL_top50.pdf"),
    height = 12,width = 14,pointsize = 1)
plot_oi_CTRL
dev.off()

png(paste0(params$out,"figures/Figure_S5-D_multiNicheNet_CTRL_top50.png"),
   height = 1700, width = 2000, units = "px", pointsize = 1, res = 150)
plot_oi_CTRL 
dev.off()

tiff(paste0(params$out,"figures/Figure_S5-D_multiNicheNet_CTRL_top50.tiff"),
    height = 1700,width = 2000, units = "px", res = 150, pointsize = 1)
plot_oi_CTRL 
dev.off() 
...
network = infer_intercellular_regulatory_network(lr_target_df, 
...
pdf(paste0(params$out,"figures/Figure_S5-B_multiNicheNet_networkGraph_NBvsCTRL.pdf"),
    height = 7, width = 20)
final_network
dev.off()

png(paste0(params$out,"figures/Figure_S5-B_multiNicheNet_networkGraph_NBvsCTRL.png"),
     height = 700,width = 2000, units = "px", res = 150, pointsize = 1)
final_network
dev.off()
...
# save results
output_CTRLvsNB <- as.data.frame(lr_target_prior_cor_filtered) 

write.table(output_CTRLvsNB, 
            file = paste0(params$out,"tables/multiNicheNet_output_CTRL-vs-NB.csv"),
            sep = "\t", quote = FALSE,row.names = FALSE)
```

## ___Exploratory analysis: MUC1/ADAM17 expression___

```{r}
VlnPlot(rna, 
        features = "MUC1",
        group.by = "group",
        split.by = "original_celltype",
        slot = "data",
        log = TRUE)
