...
path <- "/mnt/Multimodal_Imaging_Daria/_Data_Analysis/_tmp_daria/Image_analysis/20230112_DIMR_Ilastik/20230517_sc_data_combined"
...
```
We can see that cluster 47 are most probably the sticky cells, which are positive for everything. Cluster 0 are most probably cells that swam off between IF and IMC and are hence negative for everything except for DAPI. We will check which sample has the highest presence of this cluster.
