...
path <- "/home/rstudio/src/MapMet/data/NEWEST_RESULTS_temp"
...
saveRDS(clusters, file.path(path, "results/clusters-1px-postcuration_intensity-morphology.rds"))
...
col_clusters <- c(rgb(255,255,209, maxColorValue = 255),
                rgb(255,255,162, maxColorValue = 255),
...
saveRDS(mat_red, file.path(path, "results/mat_red_1px_int-morphology.rds"))
