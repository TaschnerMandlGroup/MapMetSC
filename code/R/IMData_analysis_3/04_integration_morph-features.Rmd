...
spe <- readRDS(file.path(path,"results/spe_0px_wo-lostcells.rds"))
...
saveRDS(spe, file.path(path, "results/spe_0px-curated.rds"))
...
##Save data
```{r pseudobulk, message=FALSE}
spe_1px <- readRDS(file.path(path, "results/spe_1px_refined.rds"))
spe_1px <- spe_1px[,colnames(spe)]

saveRDS(spe_1px, file.path(path, "results/spe_1px-curated.rds"))
```
