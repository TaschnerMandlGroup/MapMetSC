...
saveRDS(mat_red, file.path(path, "results/mat_red.rds"))

#mat_red <- readRDS(file.path(path,"results/mat_red.rds"))
...
```{r visualize-clusters-in-image, message=FALSE, fig.width=15}
library(dplyr)
annotation <- read.csv(file.path(path, "results", "in_house", "annotation_v3.csv"), sep=";")
...
col_metacluster <- c(brewer.pal(n-1,"Set3"), brewer.pal(12,"Paired")[12])
...
saveRDS(spe, file.path(path, "results/spe_clustered_2.rds"))
```
