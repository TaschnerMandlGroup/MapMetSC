...
```{r visualize-clusters-in-image, message=FALSE, fig.width=15}
library(dplyr)
annotation <- read.csv(file.path(path, "results", "in_house", "annotation_v7.csv"), sep=";")
...
col_clusters <- c(#"1"=rgb(255,255,162, maxColorValue = 255),
                #"2"=rgb(255,221,57, maxColorValue = 255),
                ...
                "marker-lo TC2"=rgb(230,245,201, maxColorValue = 255),
                "marker-lo TC1"=rgb(204,235,197, maxColorValue = 255),
                "ELAVL4+ cell"=rgb(179,222,105, maxColorValue = 255),
                "marker-hi TC"=rgb(198,255,72, maxColorValue = 255),
                "GATA3hi TC"=rgb(65,208,57, maxColorValue = 255),
                "marker-lo TC3"=rgb(60,119,97, maxColorValue = 255),
                ...
                "CD44+ marker-hi TC"=rgb(27,158,119, maxColorValue = 255),
...
saveRDS(spe, file.path(path, "results/in_house/spe_clustered_7.rds"))
```
