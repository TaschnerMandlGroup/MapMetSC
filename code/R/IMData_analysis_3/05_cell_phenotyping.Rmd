...
data_long <- data_wide[c(146:170),] %>% pivot_longer(cols = !sample, names_to = "cluster", values_to = "count") 
...
```{r visualize-clusters-in-image, message=FALSE, fig.width=15}
library(dplyr)
annotation <- read.csv(file.path(path, "results", "in_house", "annotation_v5.csv"), sep=";")
...
BM_cluster_names <- setNames(annotation$BM.annotation.2, annotation$cluster)
PT_cluster_names <- setNames(annotation$PT.annotation.2, annotation$cluster)
...
spe_gran <- spe[,spe$metacluster=="granulocyte" & spe$tissue=="BM"]
...
spe_gran[,spe_gran$solidity>=0.83 & spe_gran$solidity<0.93]$gran_type <- 'band_cell'
...
spe[,spe$tissue=="PT" & spe$metacluster=="granulocyte"]$celltype <- "neutrophil"
```

We will manually select distinct colors.

```{r colors, message=FALSE, fig.height=17}
col_clusters <- c("CD10+ CXCR4dim"=rgb(255,255,162, maxColorValue = 255),
                "CD10+"=rgb(255,221,57, maxColorValue = 255),
                #"3"=rgb(246,246,0, maxColorValue = 255),
                "other"=rgb(255,255,209, maxColorValue = 255),
                "Ki67+ CXCR4+"=rgb(254,217,166, maxColorValue = 255),
                "MSC"=rgb(253,180,98, maxColorValue = 255),
                "S100B- pot. NK"=rgb(255,137,0, maxColorValue = 255),
                "S100B+ pot. NK"=rgb(241,75,2, maxColorValue = 255),
                "HLA-DR+ CXCR4+"=rgb(152,78,163, maxColorValue = 255),
                "B cell"=rgb(192,159,202, maxColorValue = 255),
                "naive CD8 T cell"=rgb(188,128,189, maxColorValue = 255),
                "naive CD4 T cell"=rgb(190,174,212, maxColorValue = 255),
                "S100B+ CD8 T cell"=rgb(253,218,236, maxColorValue = 255),
                "GZMB+ PD1+ CD8 T cell"=rgb(251,154,153, maxColorValue = 255),
                "GZMB+ PD1- CD8 T cell"=rgb(242,3,137, maxColorValue = 255),
                "T cell"=rgb(251,128,114, maxColorValue = 255),
                "PD1+ CD4 T cell"=rgb(254,142,175, maxColorValue = 255),
                "PDL1+ CD8 T cell"=rgb(240,0,240, maxColorValue = 255),
                "S100B+ CD4 T cell"=rgb(227,26,28, maxColorValue = 255),
                "dense T cell region"=rgb(147,3,0, maxColorValue = 255),
                "ELAVL4- CHGA- tumor"=rgb(230,245,201, maxColorValue = 255),
                "CD24- CHGA- tumor"=rgb(204,235,197, maxColorValue = 255),
                "ELAVL4+"=rgb(179,222,105, maxColorValue = 255),
                "sympathoblast"=rgb(198,255,72, maxColorValue = 255),
                "LUMhigh tumor"=rgb(65,208,57, maxColorValue = 255),
                "GD2+CD56+"=rgb(60,119,97, maxColorValue = 255),
                "CD14+ PDL1- monocyte"=rgb(104,180,238, maxColorValue = 255),
                "monoblast"=rgb(128,177,211, maxColorValue = 255),
                "CD14- PDL1- monocyte"=rgb(51,180,180, maxColorValue = 255),
                "CHGA+ GATA3neg TC"=rgb(102,166,30, maxColorValue = 255),
                "cycling sympathoblast"=rgb(149,144,89, maxColorValue = 255),
                "CXCR4high sympathoblast"=rgb(210,205,126, maxColorValue = 255),
                "CD44high tumor"=rgb(27,158,119, maxColorValue = 255),
                "GD2low tumor"=rgb(102,194,165, maxColorValue = 255),
                "CD14+ PDL1+ monocyte"=rgb(39,130,187, maxColorValue = 255),
                "CD14- PDL1+ monocyte"=rgb(166,206,227, maxColorValue = 255),
                "pDC"=rgb(212,241,240, maxColorValue = 255),
                "band_cell"=rgb(169,189,210, maxColorValue = 255),
                ...
                "fibroblast"=rgb(212,89,67, maxColorValue = 255),
                "schwann cell"=rgb(156,76,24, maxColorValue = 255),
                "LIN- Ki67+"=rgb(174,129,37, maxColorValue = 255),
                "HPC"=rgb(212,143,75, maxColorValue = 255),
                "HSC"=rgb(143,109,113, maxColorValue = 255))
...
saveRDS(spe, file.path(path, "results/in_house/spe_clustered_5.rds"))
```
