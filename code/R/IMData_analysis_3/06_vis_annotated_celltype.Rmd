...
cell_fun = function(j, i, x, y, w, h, fill){
          ...
          grid.circle(x=x,y=y,r= percent_mat[i, j]/1.5 * min(unit.c(w, h)),
...
setEPS()
postscript(file.path(path, "results/in_house/20231030/bubbleplot_scaled3.eps"), height=7.2, width=14)
d1
dev.off()
```
