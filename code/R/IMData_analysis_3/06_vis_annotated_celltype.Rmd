...
```{r ingle-cell-heatmap-clusters-mean, message=FALSE, fig.height=13, fig.width=18}
library(scuttle)
library(bruceR)
...
mean_metacluster_wo_sticky <- mean_metaclust[mean_metaclust$Group.1!="sticky cell",]$x
