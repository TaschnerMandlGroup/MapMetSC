...
```{r cluster-abundance-per-sample, fig.width=30}
#spe <- spe_all[,spe_all$metacluster != "tumor" & spe_all$celltype!="other" & spe_all$celltype!="LIN- prol."]
