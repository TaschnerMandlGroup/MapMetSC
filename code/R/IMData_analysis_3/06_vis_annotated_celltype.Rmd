...
MNA <- proportions[, pos_samples]
nMNA <- proportions[, neg_samples]
...
Next, we will look at the mean marker expression per cluster and plot metadata in the annotation bars.
...
lgd2 = Legend(labels = c("PT", "BM"), title = "tissue",
