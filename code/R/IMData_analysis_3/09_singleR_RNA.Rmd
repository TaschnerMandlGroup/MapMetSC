...
celltype_details <- readRDS(file.path(path,"public_datasets/Fetahu/metadata.rds"))
...
saveRDS(protein_sce, file.path(path,"public_datasets/Fetahu/results/spe_predicted_clusters.rds"))
...
write.csv(data_wide, file.path(path,"public_datasets/Fetahu/results/predicted_RNA_per_protein_cluster.csv"))
...
write.csv(assignments, file.path(path,"public_datasets/Fetahu/results/similarity_assignments_tumor.csv"))
```
