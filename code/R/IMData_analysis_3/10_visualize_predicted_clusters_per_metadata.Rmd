...
saveRDS(spe, file.path(path, "results/spe_predicted-clusters.RDS"))
```
...
for(i in 1: length(samples)){
  ...
  ggsave(filename=file.path(path, paste0("results//UMAP/predicted_clusters/", samples[i] , ".tiff")), width = 10, height = 5, units = "in", device='tiff', dpi=500)
}
