...
#keep_cols <- spe$tissue=="BM" & spe$control=="no" & spe$metacluster!="tumor" & spe$metacluster!="LIN- prol." & spe$metacluster!="other" & (spe$timepoint=="DE" | spe$timepoint=="RE1") & spe$study_id%in%paired_patients
keep_cols <- spe$tissue=="PT" & spe$metacluster=="tumor" & spe$MYCN_amp!=9
