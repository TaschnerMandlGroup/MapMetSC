...
keep_cols <- spe$metacluster=="tumor" & spe$timepoint=="DE" & spe$study_id%in%paired_patients #&(spe$timepoint=="DE" | spe$timepoint=="RE2") 
...
#esign <- model.matrix(~condition, y.ab$samples)
