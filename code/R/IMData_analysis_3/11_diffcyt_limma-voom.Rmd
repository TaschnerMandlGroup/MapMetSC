...
keep_cols <- colnames(spe)#spe$metacluster !="tumor" & spe$metacluster !="mesenchymal"
...
cluster_names <- setNames(c(3,1,4,2), c(1:4))
cellular_communities$community_cluster <- recode(cellular_communities$community_cluster, !!!cluster_names)

setEPS()
postscript(file.path(path, "results/in_house/20231115/dendogram_allsamples.eps"), height=12, width=30)
plot(hc)
dev.off()

setEPS()
postscript(file.path(path, "results/in_house/20231115/barplot_allsamples.eps"), height=12, width=20)
p
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/in_house/20231115/barplot_allsamples_tumor.eps"), height=12, width=20)
p_tu
dev.off()
```
...
setEPS()
postscript(file.path(path, "results/in_house/20231115/annotationbar_allsamples.eps"), height=30, width=30)
...
#absolute cellcount
setEPS()
postscript(file.path(path, paste0("results/in_house/20231115/annotationbar_MEcells.eps")), height=30, width=30)
...
setEPS()
postscript(file.path(path, paste0("results/in_house/20231115/annotationbar_tumor_inf_norm.eps")), height=30, width=30)
