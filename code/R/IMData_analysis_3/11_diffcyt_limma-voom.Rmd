...
keep_cols <- spe$tissue=="BM" & spe$control=="no" & spe$metacluster!="tumor" & spe$celltype!="other"  #& spe$study_id%in%paired_patients & (spe$timepoint=="DE" | spe$timepoint=="RE2") #& spe$study_id%in%paired_patients & (spe$MYCN_amp==1 | spe$MYCN_amp==3) 
