...
spe <- readRDS(file.path(path,"results/in_house/spe_clustered_12.rds"))
...
paired_patients <- intersect(BM_patients_1, PT_patients)
...
keep_cols <- spe$celltype != "other" & spe$metacluster=="tumor" & spe$study_id%in%paired_patients & spe$timepoint=="DE"#spe$metacluster !="tumor" & spe$metacluster !="mesenchymal"
