...
spe <- readRDS(file.path(path,"results/in_house/spe_clustered_11.rds"))
...
columnAnnotation(ALK_mut=meta_all$ALK_mut, col=list(ALK_mut=col_aberrations), show_legend=FALSE)
