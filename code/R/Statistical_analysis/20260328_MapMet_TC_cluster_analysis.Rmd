---
title: "MapMet — Tumor Cell Cluster Reliability and BM vs PT Enrichment Analysis"
...
<div class="result-note">
**CHGAhi TC, GD2lo TC, and GATA3hi TC** should be excluded from BM composition analyses. They are detected in <16% of reliable PT units and near-zero percent of reliable BM units, with strong artifact signatures (Spearman r = −0.38 to −0.59, Δdetect = 54–72pp). Their occasional appearance in low-TC-count BM samples is statistically indistinguishable from sampling noise.
</div>
...
**The metastasis claim is not supported for early SYM-like TC** — this cluster is significantly depleted in BM relative to PT in both models (logit Δ=−10pp \*\*, CLR Δ=−1.48 units \*\*\*). It is a primary-tumor-dominant subtype that does not preferentially appear in BM.
