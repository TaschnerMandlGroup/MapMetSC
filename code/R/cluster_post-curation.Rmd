...
saveRDS(clusters, file.path(path, "data/clusters-int-1px-mean_post-curation.rds"))
...
data_long <- data_wide[101:150,] %>% pivot_longer(cols = !sample, names_to = "cluster", values_to = "count") 
...
ggplot(data_long, aes(fill=cluster, y=count, x=sample)) + 
  ggtitle("Clusters per sample 101:150") +
